...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "豌豆日志",
      description: '豌豆日志致力于做最有深度的个人技术网站。',
    }
  },
  ...
  themeConfig: {
    ...
    repo: 'gavin2love/notes', // 导航栏右侧生成Github链接
  ...
  plugins: <UserPlugins>[
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        choosen: 'gitalk',
        options: {
          clientID: 'd76b35a07cf9aefa7048',
          clientSecret: '0375328c8c9be2a7b8aa64786fe0b1cb582a9548',
          repo: 'notes', // GitHub 仓库
          owner: 'gavin2love', // GitHub仓库所有者
          admin: ['gavin2love'], // 对仓库有写权限的人
